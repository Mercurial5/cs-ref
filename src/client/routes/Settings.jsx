        ...
        {(params) => (
          <>
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-x-6 gap-y-2 sm:gap-6">
              ...
              <FieldView>
                <FieldLabelView>Должнось</FieldLabelView>
                <InputView name="job_title" type="text" initial={params.initial.job_title} />
                <FieldErrorView />
              </FieldView>

              <FieldView>
                <FieldLabelView required>Название компании</FieldLabelView>
                <InputView name="company_name" type="text" initial={params.initial.company_name} />
                <FieldErrorView />
              </FieldView>
            </div>
        ...
        >
          {(params) => (
            <>
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-x-6 gap-y-2 sm:gap-6">
                <FieldView>
                  <FieldLabelView>Паспорт</FieldLabelView>
                  <FileInputView name="passport" file={params.initial.passport} />
                  <FieldErrorView />
                </FieldView>

                <FieldView>
                  <FieldLabelView>Удостоверение</FieldLabelView>
                  <FileInputView name="id_card" file={params.initial.id_card} />
                  <FieldErrorView />
                </FieldView>

                <FieldView>
                  <FieldLabelView>Страховка</FieldLabelView>
                  <FileInputView name="insurance" file={params.initial.insurance} />
                  <FieldErrorView />
                </FieldView>
              </div>
...
const FileFormLogic = ({ children, ...props }) => {
  const store = useStore();

  const form = useForm({
    values: {
      passport: store?.passport ?? null,
      insurance: store?.insurance ?? null,
      id_card: store?.["id_card"] ?? null,
    },
